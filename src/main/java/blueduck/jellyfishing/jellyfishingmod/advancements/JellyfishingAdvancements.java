package blueduck.jellyfishing.jellyfishingmod.advancements;
...
public class JellyfishingAdvancements implements Consumer<Consumer<Advancement>> {
    ...
    /**
     * Adds all the entities in  to the given advancement's criteria
     */
