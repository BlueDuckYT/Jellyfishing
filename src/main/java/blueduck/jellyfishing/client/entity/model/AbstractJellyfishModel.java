...
public class AbstractJellyfishModel extends EntityModel<AbstractJellyfishEntity> {
    ...
    @Override
    public void setRotationAngles(AbstractJellyfishEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
